...
const youtubeVideos = [
  {
    description: "Таовита делает чудеса!",
    url: "https://youtu.be/ChoN9Q2WsLU?si=BYf_Ejqtv47jjMvM",
  },
  {
    description: "Таовита. Шатающиеся Зубы укрепляются👍",
    url: "https://youtu.be/7gJKgD_TOUQ?si=xc9wRZIyZawO3Vsd",
  },
  {
    description: "Таовита Делает чудеса👍",
    url: "https://youtu.be/gg2hrbKs_PI?si=q7gWxuEoM6gx1xN0",
  },
  {
    description: "Не видевшие глаза начали видеть от Таовита",
    url: "https://youtu.be/rTrjwAw1-xI?si=2PfzbE6EdIuTO11q",
  },
  {
    description: "Таовита. Решена проблема с Простатитом👍",
    url: "https://youtu.be/IydO3iiTVZM?si=kI9ngZfE8RcZz0GR",
  },
];
...
bot.on("callback_query", (query) => {
  ...
  if (query.data === "nextReview") {
    ...
    bot
      .sendMessage(
        chatId,
        `${youtubeVideos[currentReviewIndex].description}
                ...
                isFirstVideo
                  ...
                  : [
                      { text: "Предыдущий отзыв", callback_data: "prevReview" },
                      {
                        ...
                        callback_data: "butnextReviewton2",
                      },
                    ],
              ],
            },
...
🔹  Биокомплексы полезных экстрактов`,
    ...
    case "Достижения 🏆":
      opts = {
        reply_markup: JSON.stringify({
          keyboard: [...mainKeyboards, ["На главную"]],
          resize_keyboard: true,
          one_time_keyboard: true,
        }),
      };
...
Уникальные продуктовые бренды, разработанные на основе собственных инновационных и запатентованных натуральных составов — на пользу людям`;
    ...
    case "Контакты ✉️":
      ...
      bot.sendMessage(chatId, `Мои контакты:`, contactButtons);
      bot.sendMessage(chatId, `Сотовый: +996550915445`, opts);
  }
});
