...
const contactButtons = Markup.keyboard([
    Markup.button.url('Instagram', 'https://www.instagram.com/bekt4naliev/'),
    Markup.button.url('WhatsApp', 'https://wa.me/996709550233'),
    Markup.button.url('Telegram', 'https://t.me/@beksbek'),
...
Уникальные продуктовые бренды, разработанные на основе собственных инновационных и запатентованных натуральных составов — на пользу людям`
            ...
            break
        case "Контакты ✉️":
            bot.sendMessage(chatId, 'Контакты: ', contactButtons);
    }
});
